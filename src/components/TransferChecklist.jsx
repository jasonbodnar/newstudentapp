const STEP_DEFS = [
  {
    ...
    note: 'Family completed enrollment. Student appears in the SIS and syncs to HandRail via Clever/ClassLink rostering.',
  },
  {
  ...
  },
  {
    ...
    note: 'If the sending school uses HandRail, their teacher profile arrives digitally. Otherwise the counselor builds one from records + a quick call to the sending school.',
  },
  {
    key: 'placementReady',
