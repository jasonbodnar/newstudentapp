# Bridge — Student Transition Profiles

**Every new student arrives with a story. Bridge makes sure their new school knows it.**

Bridge is a prototype web app for intentional student transitions between schools: grade-level
...
| Persona | Role | What they do in Bridge |
|---|---|---|
...
- **Out-of-state standards comparison** — when a student arrives from TX/FL/OH/IN, Bridge shows how that state's standards differ from Michigan's: what the student may not have seen, where they may be ahead, and terminology differences. *A standards gap is not a skills gap.*
...
- **District trust & procurement**: districts already vet and buy through these ecosystems; Bridge fits as an app in the Clever Library / ClassLink App Store, or as an acquisition-ready add-on.
